...
public class DataSourceServlet extends TestServlet {
    ...
    public void modifyLocale( HttpServletRequest request, HttpServletResponse response ) throws Exception {
        StringBuffer output = new StringBuffer();

        Locale backup = Locale.getDefault();
        output.append("First call of Locale.getDefault(): " + backup.toString());

        Locale.setDefault(Locale.US);
        backup = Locale.getDefault();
        output.append("Second call of Locale.getDefault(): " + backup.toString());

        respond(response, output.toString());
    }
